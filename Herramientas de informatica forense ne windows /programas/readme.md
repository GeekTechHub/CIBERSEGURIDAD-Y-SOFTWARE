...
inicios de sesión, errores, advertencias, procesos ejecutados y cambios importantes. En ciberseguridad 
\es fundamental porque ayuda a detectar accesos remotos, intentos de intrusión, borrado de registros y
...
• 	Control de aplicaciones: Permite configurar qué programas pueden conectarse a Internet y cuáles no.
• 	Gestión de puertos y protocolos: Puedes abrir o cerrar puertos específicos (ej. 80 para web, 443 para HTTPS) según tus necesidades.
...
• 	Cuentas de usuario: Crear, modificar o eliminar usuarios, cambiar contraseñas y gestionar permisos.
• 	Red y seguridad: Configurar conexiones de red, firewall, opciones de seguridad y cifrado.
• 	Sonido y pantalla: Ajustar volumen, dispositivos de audio, resolución y calibración de pantalla.
• 	Accesibilidad: Herramientas para usuarios con necesidades especiales (narrador, lupa, teclado en pantalla).
• 	Programas: Instalar, desinstalar o modificar aplicaciones.
• 	Fecha y hora: Cambiar zona horaria, sincronizar reloj con servidores de Internet.
• 	Copias de seguridad y restauración: Crear puntos de restauración y gestionar backups.
